    ...
    <nav class="main-header navbar navbar-expand-md " style="background-color: #077F46">
      <div class="container">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto ">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link text-white rightBar" style="  border-bottom: 3px solid white;"><i class="fas fa-user-plus"></i> REGISTER</a>
          </li>
          <li class="nav-item">
            ...
            <div class="row mb-3">
              <div class="col-sm-4">
                <div class="card  h-100">
                  <div class="card-body " style="border: 10px solid rgba(7, 127, 70,.75); border-radius: 0;">
              ...
              <div class="col-sm-8">
                <div class="card  card-tabs h-100" style="border: 10px solid rgba(7, 127, 70,.75); border-radius: 0;">
                  <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active text-success" id="basic-info-tab" data-toggle="pill" href="#basic-info" role="tab" aria-controls="basic-info" aria-selected="true">Basic Info</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-success" id="other-info-tab" data-toggle="pill" href="#other-info" role="tab" aria-controls="other-info" aria-selected="false">Other Info</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-success" id="guardian-tab" data-toggle="pill" href="#guardian" role="tab" aria-controls="guardian" aria-selected="false">Guardian</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-success" id="account-tab" data-toggle="pill" href="#account" role="tab" aria-controls="account" aria-selected="false">Account</a>
                      </li>
                    </ul>
                  </div>
                  <div class="card-body">
