    ...
    <div class="modal-content">
      ...
      <form id="recoverPasswordForm" method="post">
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="contact_number" maxlength="4" id="contact_number" class="form-control" placeholder="CORRECT LAST 4 DIGIT NUMBER">
                  </div>
                </div>
                <div class="col-sm-12 ">
                  <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="button" class="btn bg-dark px-3" data-dismiss="modal"><i class="fas fa-times"></i> CLOSE</button>
          <?php
          if ($count > 0) {
            echo '<button type="submit" class="btn btn-primary px-3"><i class="fas fa-save"></i> SAVE</button>';
          }
          ?>
