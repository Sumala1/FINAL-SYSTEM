    ...
    <nav class="main-header navbar navbar-expand-md " style="background-color: #077F46">
      <div class="container">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto ">
          <li class="nav-item">
            <a href="#" class="nav-link text-white rightBar" style="border-bottom: 3px solid white;">HOME</a>
          </li>
          <li class="nav-item">
    ...
    <div class="content-wrapper">
      ...
      <div class="content  ">
        <div class="container-fluid pt-5">
          <div class="card pt-4 pb-4" style=" background-color: rgba(7, 127, 70,.60);">

            <div class="card-body text-center text-white">
              <h1 class="card-text mb-4" style="font-weight: 1000">WELCOME</h1>
              <img src="assets/dist/img/<?= $image; ?>" alt="logo" class="img-circle logo">
              <h1 class="card-text mt-4" style="font-weight: 1000; text-transform: uppercase; "><?= $barangay ?>, <?= $zone ?></h1>
              <br>
              <br>
              <a href="login.php" class="btn bg-success btn-lg px-3 text-white" style="font-weight: 900; border: 2px solid #fff">LOGIN</a>
            </div>
          </div>
