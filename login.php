    ...
    <nav class="main-header navbar navbar-expand-md " style="background-color: #077F46">
      <div class="container">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto ">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link text-white rightBar" style="  border-bottom: 3px solid white;"><i class="fas fa-user-alt"></i> LOGIN</a>
          </li>
        </ul>
      </div>
    </nav>
            ...
            <form id="loginForm" method="post">
              <div class="card " style="border: 10px solid rgba(7, 127, 70,.75); border-radius: 8;">
                <div class="card-body text-center text-white">
                  ...
                  <div class="col-sm-12">
                    <h1 class="card-text mt-2" style="font-weight: 1000; color: #077F46">BARANGAY PORTAL</h1>
                  </div>
                    ...
                    <div class="form-group">
                      <div class="input-group mb-3" id="show_hide_password">
                        ...
                        <div class="input-group-append bg">
                          <span class="input-group-text bg-transparent"> <a href="" style=" text-decoration:none;"><i class="fas fa-eye-slash text-dark" aria-hidden="true"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-12 text-right">
                    <a href="forgot.php" class="text-dark">Forgot Password</a>
                  </div>
                  <div class="col-sm-12 mt-4 mb-2">
                    <button type="submit" class="btn bg-green btn-lg btn-block">Sign In</button>
                  </div>
                </div>
            </form>
          </div>
